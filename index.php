...
include_once "./arquivos/dao/UsuarioDAO.php";
include_once "./arquivos/model/Usuario.php";
    ...
    <nav class="navbar navbar-light bg-light menu">
        <div class="container">
            <a class="navbar-brand" href="#">
                CRUD PDO - PHP Com Banco de Dados
            </a>
        </div>
    </nav>
    <div class="container">
        <form action="arquivos/controller/UsuarioController.php" method="POST">
            <div class="row">
                <div class="col-md-3">
                    <label>Nome</label>
                    ...
                    <?php foreach ($usuariodao->read() as $usuario) : ?>
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                <a href="arquivos/controller/UsuarioController.php?del=<?= $usuario->getId() ?>">
